...
random_twenty = [[3,5,2,6,8,1,9,6,2,9,2,0,1,3,8,7,2,9,10,4], "random 20"]
bubble_sort_for_quick_sort_test = [1,1,1,4,8,3,9,6,2,9,2,0,5,3,8,7,2,4,3,1]
...
print(check_if_in_order(new_quick_sort(arg)))
